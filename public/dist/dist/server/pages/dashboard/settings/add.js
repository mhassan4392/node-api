...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/dashboard/settings/add.vue?vue&type=template&id=42dfb622&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-container',[_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('CrudDataTable',{attrs:{"default-item":_vm.defaultItem,"table":{
            heading: _vm.$t('crud.table.headings.settings.add'),
            search: true,
            showSelect: true,
            button: {
              text: _vm.$t('crud.table.addNewButtons.settings.add')
            }
          },"add-edit-dialog":{
            addHeading: _vm.$t('addEditDialog.headings.add.settings.add'),
            editHeading: _vm.$t('addEditDialog.headings.edit.settings.add')
          ...
          var setting = ref.item;
return [_c('SettingForm',{attrs:{"setting":setting}})]}}])})],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/dashboard/settings/add.vue?vue&type=template&id=42dfb622&

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/forms/settings/SettingForm.vue?vue&type=template&id=a4ea02a6&
var SettingFormvue_type_template_id_a4ea02a6_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-card-text',[_c('v-container',[_c('v-text-field',{attrs:{"label":_vm.$t('forms.labels.name'),"outlined":"","dense":"","rules":[_vm.rules.required]},model:{value:(_vm.setting.name),callback:function ($$v) {_vm.$set(_vm.setting, "name", $$v)},expression:"setting.name"}}),_vm._v(" "),_c('v-textarea',{attrs:{"label":_vm.$t('forms.labels.settings'),"outlined":"","dense":"","height":"500px"},model:{value:(_vm.setting.settings),callback:function ($$v) {_vm.$set(_vm.setting, "settings", $$v)},expression:"setting.settings"}})],1)],1)}
var SettingFormvue_type_template_id_a4ea02a6_staticRenderFns = []


// CONCATENATED MODULE: ./components/forms/settings/SettingForm.vue?vue&type=template&id=a4ea02a6&

// EXTERNAL MODULE: ./mixins/validations.js
var validations = __webpack_require__(493);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/forms/settings/SettingForm.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./components/forms/settings/SettingForm.vue?vue&type=script&lang=js&
 /* harmony default export */ var settings_SettingFormvue_type_script_lang_js_ = (SettingFormvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(21);
...
// CONCATENATED MODULE: ./components/forms/settings/SettingForm.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  settings_SettingFormvue_type_script_lang_js_,
  SettingFormvue_type_template_id_a4ea02a6_render,
  SettingFormvue_type_template_id_a4ea02a6_staticRenderFns,
  false,
  injectStyles,
  null,
  "4ab55123"
...
/* harmony default export */ var SettingForm = (component.exports);
...
installComponents_default()(component, {VCardText: VCard["d" /* VCardText */],VContainer: VContainer["a" /* default */],VTextField: VTextField["a" /* default */],VTextarea: VTextarea["a" /* default */]})

// EXTERNAL MODULE: ./components/crud/CrudDataTable.vue + 4 modules
var CrudDataTable = __webpack_require__(499);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dashboard/settings/add.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./pages/dashboard/settings/add.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/dashboard/settings/add.vue
...
installComponents_default()(add_component, {VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VRow: VRow["a" /* default */]})
